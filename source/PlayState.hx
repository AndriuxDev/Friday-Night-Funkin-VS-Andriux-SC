			...
			case 'gameCity':
				{
						defaultCamZoom = 0.9;
						curStage = 'normalCity';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('gameCity/normalCity'));
						bg.antialiasing = true;
			...
			case 'crisisCity':
				{
						defaultCamZoom = 0.9;
						curStage = 'crisisCity';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('gameCity/crisisCity'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
